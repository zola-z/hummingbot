...
from hummingbot.connector.derivative.msx_perpetual import msx_perpetual_web_utils as web_utils
...
class MsxPerpetualUserStreamDataSourceUnitTests(IsolatedAsyncioWrapperTestCase):
    ...
    async def asyncSetUp(self) -> None:
        ...
        self.connector = MsxPerpetualDerivative(
            msx_perpetual_api_key="",
            msx_perpetual_api_secret="",
            domain=self.domain,
            trading_pairs=[])

        self.auth = MsxPerpetualAuth(api_key=self.api_key,
        ...
        self.data_source = MsxPerpetualUserStreamDataSource(
    ...
    @aioresponses()
    @patch("hummingbot.connector.derivative.msx_perpetual.msx_perpetual_user_stream_data_source.MsxPerpetualUserStreamDataSource._sleep")
    ...
    @patch(
        "hummingbot.connector.derivative.msx_perpetual.msx_perpetual_user_stream_data_source.MsxPerpetualUserStreamDataSource"
        "._ping_listen_key",
    ...
    @patch("hummingbot.connector.derivative.msx_perpetual.msx_perpetual_user_stream_data_source.safe_ensure_future")
