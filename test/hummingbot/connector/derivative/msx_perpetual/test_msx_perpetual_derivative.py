...
class MsxPerpetualDerivativeUnitTest(IsolatedAsyncioWrapperTestCase):
    ...
    @aioresponses()
    @patch("hummingbot.connector.derivative.msx_perpetual.msx_perpetual_derivative."
           "MsxPerpetualDerivative.current_timestamp")
    ...
    @aioresponses()
    @patch("hummingbot.connector.derivative.msx_perpetual.msx_perpetual_web_utils.get_current_server_time")
