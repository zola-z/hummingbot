...
from hummingbot.connector.derivative.msx_perpetual.msx_perpetual_web_utils import (
...
class MsxPerpetualWebUtilsUnitTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.pre_processor = MsxPerpetualRESTPreProcessor()

    def async_run_with_timeout(self, coroutine: Awaitable, timeout: float = 1):
        ret = self.ev_loop.run_until_complete(asyncio.wait_for(coroutine, timeout))
        return ret

    def test_msx_perpetual_rest_pre_processor_non_post_request(self):
    ...
    def test_msx_perpetual_rest_pre_processor_post_request(self):
        request: RESTRequest = RESTRequest(
